...
class PP_Plugin_Updater {
	...
	public function check_update( $_transient_data ) {
		...
		if ( false !== $current && is_object( $current ) && isset( $current->new_version ) ) {
			...
			$current->icons = array(
				'1x'      => POWERPACK_ELEMENTS_URL . 'assets/images/icon-128x128.png',
				'2x'      => POWERPACK_ELEMENTS_URL . 'assets/images/icon-256x256.png',
				'default' => POWERPACK_ELEMENTS_URL . 'assets/images/icon-256x256.png',
			);
		}
	...
	public function show_update_notification( $file, $plugin ) {
		...
		echo '<script> if ( jQuery("#pp-elements-update").prev("tr").addClass("update").hasClass("active") ) {  jQuery("#pp-elements-update").addClass("active"); } </script>';
		echo '</p></div></td></tr>';
	}
