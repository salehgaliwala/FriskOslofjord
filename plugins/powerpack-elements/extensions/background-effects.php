...
class Extension_Background_Effects extends Extension_Base {
	...
	public static function get_description() {
		return esc_html__( 'Adds background effects to sections allowing you to show particle backgrounds and more fancy effects for sections.', 'powerpack' );
	}
	...
	private function add_controls( $element, $args ) {
		...
		$element->add_control(
			...
			array(
				'label'              => esc_html__( 'Background Effects', 'powerpack' ),
		...
		$element->add_control(
			...
			array(
				'label'              => esc_html__( 'Enable Background Effects', 'powerpack' ),
		...
		$element->add_control(
			'pp_animation_type',
			array(
				'label'     => esc_html__( 'Animation Types', 'powerpack' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'nasa',
				'options'   => array(
					'birds'     => esc_html__( 'Birds', 'powerpack' ),
					'fog'       => esc_html__( 'Fog', 'powerpack' ),
					'waves'     => esc_html__( 'Waves', 'powerpack' ),
					'net'       => esc_html__( 'Net', 'powerpack' ),
					'dots'      => esc_html__( 'Dots', 'powerpack' ),
					'particles' => esc_html__( 'Line Particles', 'powerpack' ),
					'nasa'      => esc_html__( 'NASA', 'powerpack' ),
					'bubble'    => esc_html__( 'Bubble', 'powerpack' ),
					'snow'      => esc_html__( 'Snow', 'powerpack' ),
		...
		$element->add_control(
			'part_opacity',
			array(
				'label'     => esc_html__( 'Color Opacity', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0,
		...
		$element->add_control(
			'part_rand_opacity',
			array(
				'label'              => esc_html__( 'Randomized Opacity', 'powerpack' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => '',
				'label_on'           => esc_html__( 'Yes', 'powerpack' ),
				'label_off'          => esc_html__( 'No', 'powerpack' ),
		...
		$element->add_control(
			'part_speed',
			array(
				'label'     => esc_html__( 'Moving Speed', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0,
		...
		$element->add_control(
			'part_direction',
			array(
				'label'     => esc_html__( 'Moving direction', 'powerpack' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'none',
				'options'   => array(
					'none'         => esc_html__( 'Default', 'powerpack' ),
		...
		$element->add_control(
			...
			array(
				...
				'options'   => array(
					'none'     => esc_html__( 'Default', 'powerpack' ),
					'grab'     => esc_html__( 'Grab', 'powerpack' ),
					'bubble'   => esc_html__( 'Bubble', 'powerpack' ),
					'repulse'  => esc_html__( 'Repulse', 'powerpack' ),
					'noeffect' => esc_html__( 'None', 'powerpack' ),
				),
				'condition' => array(
					'pp_background_effects_enable' => 'yes',
					'pp_animation_type'            => array( 'particles', 'nasa', 'bubble', 'snow' ),
		...
		$element->add_control(
			'part_hover_size',
			array(
				'label'     => esc_html__( 'Particles Size on Hover', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0,
		...
		$element->add_control(
			'bird_color_mode',
			array(
				'label'     => esc_html__( 'Color Mode', 'powerpack' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'lerp',
				'options'   => array(
					'lerp'             => esc_html__( 'Lerp', 'powerpack' ),
					'variance'         => esc_html__( 'Variance', 'powerpack' ),
					'lerpGradient'     => esc_html__( 'Lerp Gradient', 'powerpack' ),
					'varianceGradient' => esc_html__( 'Variance Gradient', 'powerpack' ),
				),
				'condition' => array(
					'pp_background_effects_enable' => 'yes',
					'pp_animation_type'            => 'birds',
		...
		$element->add_control(
			'bird_size',
			array(
				'label'     => esc_html__( 'Bird Size', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 1,
		...
		$element->add_control(
			'bird_wing_span',
			array(
				'label'     => esc_html__( 'Wing Span', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 10,
		...
		$element->add_control(
			'bird_speed_limit',
			array(
				'label'     => esc_html__( 'Speed Limit', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 1,
		...
		$element->add_control(
			'bird_separation',
			array(
				'label'     => esc_html__( 'Separation', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 1,
		...
		$element->add_control(
			'bird_cohesion',
			array(
				'label'     => esc_html__( 'Cohesion', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 1,
		...
		$element->add_control(
			'fog_blur_factor',
			array(
				'label'     => esc_html__( 'Blur Factor', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0.1,
		...
		$element->add_control(
			'fog_zoom',
			array(
				'label'     => esc_html__( 'Zoom', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0.1,
		...
		$element->add_control(
			'waves_shininess',
			array(
				'label'     => esc_html__( 'Shininess', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0,
		...
		$element->add_control(
			'waves_height',
			array(
				'label'     => esc_html__( 'Wave Height', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 0,
		...
		$element->add_control(
			'net_points',
			array(
				'label'     => esc_html__( 'Points', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 1,
		...
		$element->add_control(
			'net_max_distance',
			array(
				'label'     => esc_html__( 'Max Distance', 'powerpack' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'min'  => 10,
		...
		$element->add_control(
			'net_show_dot',
			array(
				'label'              => esc_html__( 'Show Dot', 'powerpack' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'true',
				'label_on'           => esc_html__( 'Yes', 'powerpack' ),
				'label_off'          => esc_html__( 'No', 'powerpack' ),
		...
		$element->add_control(
			'effect_hide_tablet',
			array(
				'label'              => esc_html__( 'Hide on Tablet', 'powerpack' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'label_off',
				'label_on'           => esc_html__( 'Hide', 'powerpack' ),
				'label_off'          => esc_html__( 'Show', 'powerpack' ),
				'return_value'       => 'hide',
				'frontend_available' => true,
				'condition'          => array(
					'pp_background_effects_enable' => 'yes',
