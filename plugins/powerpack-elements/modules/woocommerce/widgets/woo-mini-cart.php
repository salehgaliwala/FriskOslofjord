	...
	protected function render() {
		...
		<div <?php $this->print_render_attribute_string( 'container' ); ?>>
			...
			if ( 'floating' === $settings['button_position'] ) {
				$placeholder = sprintf( esc_html__( 'Mini Cart button is floating. Click here to edit the "%1$s" settings. This placeholder will not be shown on the live page.', 'powerpack' ), esc_attr( $this->get_title() ) );
