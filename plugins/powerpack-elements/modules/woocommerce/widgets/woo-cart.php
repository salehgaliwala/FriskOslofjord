...
class Woo_Cart extends Woo_Base_Widget {
	...
	/**
	 * Retrieve the list of scripts the Woo - Cart widget depended on.
	 *
	 * @access public
	 *
	...
	protected function register_content_general_controls() {
		...
		$this->add_control(
			'show_cross_sells',
			array(
				'label'              => esc_html__( 'Show Cross Sells', 'powerpack' ),
	...
	protected function register_style_form_coupon_controls() {
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Coupon Button', 'powerpack' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => array(
					'show_coupon' => 'yes',
	...
	protected function register_content_coupon_controls() {
		...
		$this->add_control(
			'show_coupon',
			array(
				'label'              => esc_html__( 'Show Coupon Field', 'powerpack' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'yes',
				'return_value'       => 'yes',
				'frontend_available' => true,
	...
	protected function register_style_cart_table_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Cart Table', 'powerpack' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Border Collapse', 'powerpack' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'collapse',
				'options'   => array(
					'inherit'  => esc_html__( 'Theme Default', 'powerpack' ),
					'collapse' => esc_html__( 'Collapse', 'powerpack' ),
					'separate' => esc_html__( 'Separate', 'powerpack' ),
				),
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Cart Items', 'powerpack' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Quantity Input', 'powerpack' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Product Remove Icon', 'powerpack' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
	...
	protected function register_style_cart_totals_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Cart Totals', 'powerpack' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Table Text', 'powerpack' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Table Headings', 'powerpack' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
	...
	protected function register_style_return_to_shop_button_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Return to Shop Button', 'powerpack' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	protected function register_style_cross_sells_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Cross Sells', 'powerpack' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'show_cross_sells' => 'yes',
				),
