...
class Faq extends Powerpack_Widget {
	...
	protected function register_content_faqs_controls() {
		...
		if ( class_exists( 'acf' ) ) {
			$source_options['acf'] = esc_html__( 'ACF Repeater Field', 'powerpack' );
		}
		...
		$repeater->start_controls_tabs( 'accordion_tabs_content_tabs' );
			...
			$repeater->start_controls_tab(
				...
				$repeater->add_control(
					'tab_title',
					[
						'label'                 => esc_html__( 'Question', 'powerpack' ),
		...
		$this->add_control(
			'default_active_tabs',
			[
				'label'                 => esc_html__( 'Default Active Tabs', 'powerpack' ),
				'description'           => esc_html__( 'Add comma separated list of tab numbers.', 'powerpack' ),
				'type'                  => Controls_Manager::TEXT,
				'default'               => '',
				'dynamic'               => [
					'active' => true,
	...
	protected function register_content_settings_controls() {
		...
		$this->add_control(
			'question_html_tag',
			[
				'label'                 => esc_html__( 'Question HTML Tag', 'powerpack' ),
				'type'                  => Controls_Manager::SELECT,
				'default'               => 'div',
				'options'               => [
	...
	protected function register_content_toggle_icon_controls() {
		...
		$this->add_control(
			...
			[
				'label'                 => esc_html__( 'Open Icon', 'powerpack' ),
				'type'                  => Controls_Manager::ICONS,
				'label_block'           => false,
				'skin'                  => 'inline',
	...
	public function pp_parse_text_editor( $content ) {
