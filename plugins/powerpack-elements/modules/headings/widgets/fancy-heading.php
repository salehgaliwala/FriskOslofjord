...
class Fancy_Heading extends Powerpack_Widget {
	...
	protected function render() {
		...
		if ( $settings['heading_text'] ) {
			...
			?>
			<<?php echo esc_html( $heading_html_tag ); ?> <?php $this->print_render_attribute_string( 'fancy-heading' ); ?>>
				<?php
				if ( '' !== $settings['link']['url'] ) { ?>
					<a <?php $this->print_render_attribute_string( 'fancy-heading-link' ); ?>>
					<?php
				}
				?>
				<span <?php $this->print_render_attribute_string( 'heading_text' ); ?>>
