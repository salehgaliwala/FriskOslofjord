...
class Info_List extends Powerpack_Widget {
	...
	protected function render() {
		...
		<div <?php $this->print_render_attribute_string( 'info-list' ); ?>>
			<ul <?php $this->print_render_attribute_string( 'info-list-items' ); ?>>
				<?php foreach ( $settings['list_items'] as $index => $item ) : ?>
					<?php if ( $item['text'] || $item['description'] ) { ?>
						<li <?php $this->print_render_attribute_string( 'list-item' ); ?>>
							<?php
								...
								<div class="pp-info-list-item-inner">
									...
									<div class="pp-infolist-content-wrapper">
										...
										if ( $item['text'] ) {
											...
											?>
											<<?php echo esc_html( $title_tag ); ?> <?php $this->print_render_attribute_string( $text_key ); ?>>
										...
										<?php if ( 'button' === $item['link_type'] && ! empty( $item['link']['url'] ) ) { ?>
											<div <?php $this->print_render_attribute_string( $button_key ); ?>>
												<a <?php $this->print_render_attribute_string( $link_key ); ?>>
													<div <?php $this->print_render_attribute_string( 'info-list-button' ); ?>>
	...
	protected function render_infolist_icon( $item, $i ) {
		...
		if ( 'none' !== $item['pp_icon_type'] ) {
			...
			?>
			<div <?php $this->print_render_attribute_string( $icon_wrap_key ); ?>>
				<?php
