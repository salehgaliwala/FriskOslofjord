...
class Skin_Creative extends Skin_Base {
	...
	public function add_creative_authorbox_controls() {
		$this->start_controls_section(
			'section_author_box',
			array(
				'label' => esc_html__( 'Author Box', 'powerpack' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Author Avtar', 'powerpack' ),
		...
		$this->add_control(
			'author_avatar',
			array(
				'label'        => esc_html__( 'Show Author Avatar', 'powerpack' ),
	...
	public function add_creative_author_box_style_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Avatar Image Width', 'powerpack' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', 'rem', 'custom' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Avatar Image Spacing', 'powerpack' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', 'rem', 'custom' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'author_name_color',
			array(
				'label'     => esc_html__( 'Author Name Color', 'powerpack' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#D8D8D8',
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Author Name Hover Color', 'powerpack' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
