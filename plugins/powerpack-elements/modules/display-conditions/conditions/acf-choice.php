...
class Acf_Choice extends Acf_Base {
	...
	public function get_title() {
		return esc_html__( 'ACF Choice', 'powerpack' );
	}
	...
	public function get_name_control() {
		return wp_parse_args( [
			'description'   => esc_html__( 'Search ACF "Select", "Checkbox" and "Radio" fields by label.', 'powerpack' ),
	...
	public function get_value_control() {
		return [
			...
			'default'       => '',
			'placeholder'   => esc_html__( 'Choices', 'powerpack' ),
			'description'   => esc_html__( 'Enter each accepted choice on a separate line. You can specify the value ( red ) or both value and label ( red : Red ).', 'powerpack' ),
			'label_block'   => true,
			'ai'            => [
				'active' => false,
			],
