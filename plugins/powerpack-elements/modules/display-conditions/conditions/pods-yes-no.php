...
class Pods_Yes_No extends Pods_Base {
	...
	public function get_title() {
		return esc_html__( 'Pods Yes / No', 'powerpack' );
	}
	...
	public function get_name_control() {
		return wp_parse_args( [
			'description'   => esc_html__( 'Search Pods Yes / No field by label.', 'powerpack' ),
	...
	public function get_value_control() {
		return [
			...
			'label_block'   => true,
			'options'       => [
				'true'      => esc_html__( 'Yes', 'powerpack' ),
				'false'     => esc_html__( 'No', 'powerpack' ),
			],
		];
	}
