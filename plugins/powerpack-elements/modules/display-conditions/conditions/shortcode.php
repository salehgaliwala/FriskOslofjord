...
class Shortcode extends Condition {
	...
	public function get_title() {
		return esc_html__( 'Shortcode', 'powerpack' );
	}
	...
	public function get_name_control() {
		return [
			...
			'default'       => '',
			'placeholder'   => esc_html__( '[shortcode attribute="value"]', 'powerpack' ),
			'label_block'   => true,
			'ai'            => [
				'active' => false,
			],
	...
	public function get_value_control() {
		return [
			...
			'default'       => '',
			'description'   => esc_html__( 'Enter the string that the shortcode needs to return in order for the condition to apply.', 'powerpack' ),
			'ai'            => [
				'active' => false,
			],
		];
