...
class PP_Magic_Wand {
	...
	public static function add_extension_setting( $extensions ) {
		$extensions['pp-magic-wand'] = esc_html__( 'Magic Wand (Copy/Paste)', 'powerpack' );
		return $extensions;
	}
	...
	public static function section_magic_wand( $element, $args ) {
		$element->start_controls_section(
			...
			array(
				...
				'label' => esc_html__( 'PP Magic Wand', 'powerpack' ),
			)
		);
	...
	public static function section_magic_wand_controls( $element, $args ) {
		$element->add_control(
			...
			array(
				...
				'label'              => esc_html__( 'Enable', 'powerpack' ),
				'default'            => '',
	...
	public static function enqueue_magic_wand_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'widget_not_found'  => esc_html__( 'The widget type you are trying to paste is not available on this site.', 'powerpack' ),
				/* translators: %s: html tags */
				'pp_copy'           => sprintf( esc_html__( '%1s Copy', 'powerpack' ), 'PPE' ),
				/* translators: %s: html tags */
				'pp_paste'          => sprintf( esc_html__( '%1s Paste', 'powerpack' ), 'PPE' ),
	...
	public static function process_media_import() {
		...
		if ( empty( $content ) ) {
			wp_send_json_error( esc_html__( 'Empty content cannot be processed.', 'powerpack' ) );
		}
